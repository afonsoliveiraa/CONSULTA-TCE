...
interface VehicleFiltersCardProps {
  ...
  onPlacaOuRenavamChange: (value: string) => void;
  onCodigoMunicipioChange: (value: string) => void;
  onSubmit: (event: Event) => Promise<void>;
}

export const VehicleFiltersCard: FunctionalComponent<VehicleFiltersCardProps> = ({
  placaOuRenavam,
  codigoMunicipio,
  municipios,
  mensagemConsulta,
    ...
    <article class="filters-card contracts-filters-card contracts-filters-card--standalone">
      ...
      <form class="contracts-filters-form" onSubmit={onSubmit}>
        <div class="filters-card__fields">
          ...
          <label class="filters-card__field">
            <span class="filters-card__field-label">Placa ou RENAVAM</span>
            <div class="filters-card__input-wrap">
              ...
              <input
                id="placa-ou-renavam"
                type="text"
                value={placaOuRenavam}
                onInput={(event) => onPlacaOuRenavamChange(event.currentTarget.value)}
                placeholder="Deixe em branco para trazer todos os veiculos"
              />
            </div>
          </label>
          ...
          >
            {carregandoConsulta ? "Consultando..." : "Buscar veiculo"}
          </button>
        </div>
      </form>
    </article>
