...
interface VehicleColumnsModalProps {
  columns: VehicleColumnDefinition[];
  onClose: () => void;
  onColumnVisibilityChange: (columnId: VehicleColumnId, checked: boolean) => void;
}

export const VehicleColumnsModal: FunctionalComponent<VehicleColumnsModalProps> = ({
  columns,
  onClose,
